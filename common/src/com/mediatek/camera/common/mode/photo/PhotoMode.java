...
import javax.annotation.Nullable;
 //zhupeng-20190330 add for factory test intent ACTION_IMAGE_CAPTURE start add by lixiang 20190530
   ...
   //zhupeng-20190330 add for factory test intent ACTION_IMAGE_CAPTURE start add by lixiang 20190530
    ...
    public void init(@Nonnull IApp app, @Nonnull ICameraContext cameraContext,
        ...
        if(intent != null && intent.getAction() != null && intent.getAction().equals(MediaStore.ACTION_IMAGE_CAPTURE)){
        	 int intentCameraId = intent.getIntExtra(EXTRAS_CAMERA_FACING, -1);
            android.util.Log.d("zpp", "intentCameraId is: "+intentCameraId+"");
            if(intentCameraId == 0){  // back face
                mCameraId = "0";
            }else if(intentCameraId == 1){  // front face
                mCameraId = "1";
            }else{   //   -1 not set 
